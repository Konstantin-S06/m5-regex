...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        // - Non-empty (handled by minLength check)
    ...
    public static List<String> extractEmails(String str) {
        ...
        // Match emails ending with @mail.utoronto.ca or @utoronto.ca
        // with at least one character before the @
    ...
    public static boolean checkForDoubles(String str) {
        ...
        // Use backreference to find any capital letter that appears twice
